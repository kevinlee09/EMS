...
public:
    ...
    COrient2D(const char* filename, const char* outfilename)
    {
        ...
        // const char *conf_name = "1_conf.png";
        // // m_orientMap.writeOrient(conf_name);
        // m_orientMap.writeConfidence(conf_name);
...
#pragma omp parallel for
                      ...
                      int orientations, Im &out)
    {
        ...
        Im m1(w, h), m2(w, h);
        for (int i = 0; i < orientations; i++) {            // orient: 0~180
