...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='./assets/face_recon/checkpoints',
                                 help='pretrained models are saved here')
        ...
        # self.parser.add_argument('--output', type=str, required=True, help='output dir')   # comment by chenghong
