...
class BilinearModel():
    def __init__(self, model_dir):
        ...
        self.core_tensor = np.load(f'{model_dir}/core_847_50_52.npy')         ## landmark
        ...
        # self.points = dlib.shape_predictor(os.path.join(os.path.dirname(__file__), 'dlib/shape_predictor_68_face_landmarks.dat'))
        self.points = dlib.shape_predictor('assets/face_recon/dlib/shape_predictor_68_face_landmarks.dat')
